...
public class SanphamNew_Adapter extends RecyclerView.Adapter<SanphamNew_Adapter.MyViewHolder> {
    ...
    New_OnClickListener new_onClickListener ;
    public void New_Click(New_OnClickListener new_onClickListener){
        this.new_onClickListener = new_onClickListener;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new_onClickListener.onClick(list.get(position));
            }
        });
    }
